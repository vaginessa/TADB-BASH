...
topdir = .
BUILD_DIR = /data/data/com.termux/files/home/projects/TADB-BASH
top_builddir = /data/data/com.termux/files/home/projects/TADB-BASH
srcdir = .



CC = /data/data/com.termux/files/home/android/android-ndk-r24/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi32-clang
CC_FOR_BUILD = $(CC)
YACC = bison -y
SHELL = /bin/sh
CP = cp
RM = rm -f
AR = /data/data/com.termux/files/home/android/android-ndk-r24/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
ARFLAGS = cr
RANLIB = /data/data/com.termux/files/home/android/android-ndk-r24/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib
SIZE = :
STRIP = strip
...
VENDOR = unknown
MACHTYPE = armv7a-unknown-linux-androideabi
...
BASE_LDFLAGS = -g -O2 -static -L./lib/termcap $(LOCAL_LDFLAGS) $(CFLAGS)
